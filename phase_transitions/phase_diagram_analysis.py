...
path="videos/08_02_area_f_0.555/"
...
data = np.hstack((mean_order,std_order, mean_acc,std_acc)) #stack global order params and acc data
np.savetxt("order_acc_0.555", data)    #save .txt file of orders and acc
