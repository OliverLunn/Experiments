...
This script will generate and save a .txt file containing columns containing: [global order param] [duty cycle] [area fraction]
...
if __name__ == '__main__':
    ...
    area_fractions = []
    framenumber = 0
    PARTICLE_PIXEL = 1197   #size of single particle in pixels
    TRAY_PIXEL_SIZE = 3741194   #size of tray in pixels
    ...
    if True:
        for file in tqdm(files):
            ...
            area_fraction = (particles * PARTICLE_PIXEL) / TRAY_PIXEL_SIZE   #calculate area fraction of particles
